...
public class ModBlockEntities {
    ...
    public static final BlockEntityType<ItemExporterBlockEntity> ITEM_EXPORTER_BLOCK_ENTITY = register("item_exporter", ItemExporterBlockEntity::new, ModBlocks.ITEM_EXPORTER);
