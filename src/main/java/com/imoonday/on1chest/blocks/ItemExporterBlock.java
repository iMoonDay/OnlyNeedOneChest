...
public class ItemExporterBlock extends ConnectingBlock implements ConnectBlock, BlockEntityProvider, Waterloggable, Connectable {
    ...
    public ItemExporterBlock(Settings settings) {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new ItemExporterBlockEntity(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return (world1, pos, state1, entity) -> ItemExporterBlockEntity.tick(world1, pos, state1, (ItemExporterBlockEntity) entity);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!(world.getBlockEntity(pos) instanceof ItemExporterBlockEntity entity)) {
            return ActionResult.PASS;
        }
